...
// need to disable import shadowing here for the 'internal' arg below, which we
// inherited from streadway/amqp
...
//revive:enable:import-shadowing
...
// nack channels.
func notifyConfirmHandleAckAndNack(confirmation internal.Confirmation, ack, nack chan uint64) {
	if confirmation.Ack {
...
func (channel *Channel) runNotifyConfirmOrOrphaned(
	...
	ack, nack, orphaned chan uint64,
	confirmEvents <-chan internal.Confirmation,
) {
